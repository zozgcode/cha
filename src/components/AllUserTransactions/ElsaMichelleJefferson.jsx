...
import { ElsaMichelleJeffersonTxData } from "./tXdata";

export default function ElsaMichelleJefferson() {
  return (
    <div className={style.transaction_history}>
      <div className={style.in_transaction_history}>
        ...
        {ElsaMichelleJeffersonTxData.length === 0 && (
          <div className={style.no_transaction_yet}>
            No transaction yet
          </div>
        )}
        {ElsaMichelleJeffersonTxData.map((aTxData, i) => (
